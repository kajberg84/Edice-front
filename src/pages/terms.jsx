          ...
          <div className={styles.terms_wrapper}>
            <div className={styles.terms_content_wrapper}>
              ...
              <p>
                ...
                the use of E-dice's Website, located at localhost:3000.
              </p>
              <p>
              ...
              <p>
                We employ the use of cookies. By accessing E-dice, you agreed to
                use cookies in agreement with the E-dice's Privacy Policy.{' '}
              </p>
              <p>
              ...
              <p>
                ...
                from E-dice for your own personal use subjected to restrictions
              ...
              <p>
                ...
                website. E-dice does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of E-dice,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, E-dice shall not be liable for the
              ...
              <p>
                E-dice reserves the right to monitor all Comments and to remove
              ...
              <p>
                You hereby grant E-dice a non-exclusive license to use,
              ...
              <p>
                ...
                of E-dice; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to E-dice. Please include your name, your
              ...
              <p>
                No use of E-dice's logo or other artwork will be allowed for
